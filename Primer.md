...
## Last Updated
2026-09-02 (v3.21.1 — DB Health ops visibility: SQLite ops-counter persistence + Total Operations/Plan Usage UI + sql.js WASM fix + per-type DB-error summary + lazy SQLite re-init — suite 932 pass / 4 skip; tsc 46 = baseline; docs updated, commit of increment pending user)
