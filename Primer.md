...
## Last Updated
2026-09-03 (v3.26.0 — Prod-failure triage from DB Errors / deploy logs / Tasks panel: 3 fixes — P2002 false-error reporting, plan-limit breaker false-trip, "a is not iterable" Daily Market Sync — + 12h→6h sync cadence. On `main` on top of v3.25.0. Targeted suite pass; tsc 46 = baseline. Docs complete; **diff pending user commit**.)
