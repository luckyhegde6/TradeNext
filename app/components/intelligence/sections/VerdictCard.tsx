...
const VERDICT_STYLES: Record<Verdict, { bg: string; text: string; border: string; emoji: string; bar: string }> = {
  ...
  BUY: { bg: "bg-emerald-50 dark:bg-emerald-900/20", text: "text-emerald-700 dark:text-emerald-400", border: "border-emerald-200 dark:border-emerald-800", emoji: "🟢", bar: "bg-emerald-500" },
  ...
  SELL: { bg: "bg-red-50 dark:bg-red-900/20", text: "text-red-700 dark:text-red-400", border: "border-red-200 dark:border-red-800", emoji: "🔴", bar: "bg-red-500" },
