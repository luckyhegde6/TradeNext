...
## Lesson 113: `resetSqliteStateForTests()` Nulls the Module's Captured `state` IN PLACE — a Suite That Resets Must Re-Init (`await ensureSqliteBackup()`) Before the Next Test
