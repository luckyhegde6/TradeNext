...
const nifty50Stocks = [
  ...
  'HDFCLIFE', 'HINDALCO', 'HINDUNILVR', 'HINDZINC', 'ICICIBANK', 'INDIGO',
  ...
  'ULTRACEMCO', 'WIPRO', 'ZYDUSLIFE', 'FEDERALBANK', 'GODREJCP',
  'TATAMOTORS', 'APOLLOTYRE', 'HAVELLS', 'SIEMENS', 'MUTHOOTFIN',
  'PVRINOX', 'DLF', 'ADITYABIRLA', 'LODHA', 'TATAPOWER',
  'NMDC', 'VEDL', 'HAL', 'BEL', 'CONCOR'
];
...
const basePrice: Record<string, number> = {
  ...
  'HDFCLIFE': 730, 'HINDALCO': 930, 'HINDUNILVR': 2370, 'HINDZINC': 620, 'ICICIBANK': 1390, 'INDIGO': 4900,
  ...
  'ULTRACEMCO': 13000, 'WIPRO': 200, 'ZYDUSLIFE': 680, 'FEDERALBANK': 180, 'GODREJCP': 1200,
  'TATAMOTORS': 750, 'APOLLOTYRE': 280, 'HAVELLS': 1450, 'SIEMENS': 5200, 'MUTHOOTFIN': 1400,
  'PVRINOX': 1450, 'DLF': 750, 'ADITYABIRLA': 280, 'LODHA': 280, 'TATAPOWER': 380,
  'NMDC': 240, 'VEDL': 350, 'HAL': 4200, 'CONCOR': 850
};
