...
| File | Contents |
|------|----------|
| [versions-v3.md](./changelog/versions-v3.md) | v3.5.1 → v3.0.0 (target/SL ₹0 fix + SSE live prices, recommendation performance & archival, Telegram bot, recommendations engine, risk metrics, CSV export) |
