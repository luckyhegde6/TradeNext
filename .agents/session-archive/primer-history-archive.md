# TradeNext — Primer History Archive

> Split out of `Primer.md` (v3.39.4 context-optimisation) so the file is NOT read in full
> by default. Append-only history — read on demand.
